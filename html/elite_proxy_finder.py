...
class find_http_proxy():
    ...
    def proxy_checker_req(self, proxy):
        ...
        urls = ['http://myip.dnsdynamic.org', 'https://www.astrill.com/what-is-my-ip-address.php']
        for url in urls:
            try:
    ...
    def html_handler(self, time_or_error, html, url):
        ...
        if url in ['http://myip.dnsdynamic.org']:
    ...
    def printer(self, results, country_code):
        ...
        for r in results:
            ...
            if self.quiet:
                ...
                if counter == 1:
                    # self.res = res.append(dict(zip(res_cols,(proxy.ljust(21), country_code.ljust(3), url.ljust(21), time_or_error))),ignore_index=True)
