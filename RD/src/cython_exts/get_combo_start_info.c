/* Generated by Cython 0.20.2 on Wed Sep 10 17:40:26 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__cython_exts__get_combo_start_info
#define __PYX_HAVE_API__cython_exts__get_combo_start_info
#include "pythread.h"
#include "string.h"
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from 'cython_exts.get_combo_start_info' */
...
static __Pyx_memviewslice __pyx_f_11cython_exts_20get_combo_start_info_c_get_combo_start_info(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cython_exts.get_combo_start_info"
int __pyx_module_is_main_cython_exts__get_combo_start_info = 0;

/* Implementation of 'cython_exts.get_combo_start_info' */
...
static PyObject *__pyx_pf_11cython_exts_20get_combo_start_info_c_get_combo_start_info(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_new, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_returnVar); /* proto */
...
/* "cython_exts/get_combo_start_info.pyx":6
...
static PyObject *__pyx_pw_11cython_exts_20get_combo_start_info_1c_get_combo_start_info(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_11cython_exts_20get_combo_start_info_c_get_combo_start_info(__Pyx_memviewslice __pyx_v_new, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_returnVar, CYTHON_UNUSED int __pyx_skip_dispatch) {
  long __pyx_v_r;
  long __pyx_v_z;
  long __pyx_v_s;
  long __pyx_v_e;
  ...
  __Pyx_memviewslice __pyx_v_ak = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("c_get_combo_start_info", 0);

  /* "cython_exts/get_combo_start_info.pyx":32
 *      [5]   orderTime
 *     """
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":33
 *     """
 *     cdef long r = o.shape[0]
 *     cdef long z = returnVar.shape[0]             # <<<<<<<<<<<<<<
 *     cdef long s,e,x,y
 *     cdef long p1,p2
 */
  __pyx_v_z = (__pyx_v_returnVar.shape[0]);

  /* "cython_exts/get_combo_start_info.pyx":37
 *     cdef long p1,p2
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":38
 *     cdef int i,j,k,n,t,g
 *     cdef long now = new[1]
 *     cdef long tripStartTime = 1000          # arbitrarily set high initially, but replaced early in iteration             # <<<<<<<<<<<<<<
 *     cdef long[::1] ai
 *     cdef long[::1] aj
 */
  __pyx_v_tripStartTime = 1000;

  /* "cython_exts/get_combo_start_info.pyx":43
 *     cdef long[::1] ak
 * 
 *     n=0             # <<<<<<<<<<<<<<
 *     k=0
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":44
 * 
 *     n=0
 *     k=0             # <<<<<<<<<<<<<<
 *     j=0
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":45
 *     n=0
 *     k=0
 *     j=0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":47
 *     j=0
 * 
 *     for i in range(r):             # <<<<<<<<<<<<<<
 *         ai = o[i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cython_exts/get_combo_start_info.pyx":48
 * 
 *     for i in range(r):
 *         ai = o[i]             # <<<<<<<<<<<<<<
 *         s  = ai[2]       # start time
 ...
 */
    __pyx_t_5 = -1;
    __pyx_t_4.data = __pyx_v_o.data;
    __pyx_t_4.memview = __pyx_v_o.memview;
...
__pyx_t_4.shape[0] = __pyx_v_o.shape[1];
__pyx_t_4.strides[0] = __pyx_v_o.strides[1];
...
__PYX_XDEC_MEMVIEW(&__pyx_v_ai, 1);
    ...
    /* "cython_exts/get_combo_start_info.pyx":49
 *     for i in range(r):
 *         ai = o[i]
 *         s  = ai[2]       # start time             # <<<<<<<<<<<<<<
 *         e  = ai[4]       # end time
 ...
 */
    __pyx_t_6 = 2;
    __pyx_v_s = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_6)) )));

    /* "cython_exts/get_combo_start_info.pyx":50
 *         ai = o[i]
 *         s  = ai[2]       # start time
 *         e  = ai[4]       # end time             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_7 = 4;
    __pyx_v_e = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_7)) )));

    /* "cython_exts/get_combo_start_info.pyx":52
 *         e  = ai[4]       # end time
 * 
 *         if e>now:       # is there at least one order with an endTime less than now? if not, then return for single order.             # <<<<<<<<<<<<<<
 *             n=1
 * 
 */
    __pyx_t_8 = ((__pyx_v_e > __pyx_v_now) != 0);
    if (__pyx_t_8) {

      /* "cython_exts/get_combo_start_info.pyx":53
 * 
 *         if e>now:       # is there at least one order with an endTime less than now? if not, then return for single order.
 *             n=1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cython_exts/get_combo_start_info.pyx":57
 *         # if t==endTime, it is too late to change DG's next destination
 ...
 *             j=i                                         # j == row index pt
 */
    __pyx_t_8 = (((__pyx_v_s - __pyx_v_now) < (__pyx_v_tripStartTime - __pyx_v_now)) != 0);
    if (__pyx_t_8) {
      __pyx_t_9 = (((__pyx_v_s - __pyx_v_now) > 0) != 0);
    ...
    if (__pyx_t_10) {
      ...
      /* "cython_exts/get_combo_start_info.pyx":58
 *         # these two below conditions find the first tripPt that can be changed, i.e., tripPt that DG is not on route to
 *         if s-now < tripStartTime-now and s-now>0:
 *             tripStartTime = s             # <<<<<<<<<<<<<<
 *             j=i                                         # j == row index pt
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":59
 *         if s-now < tripStartTime-now and s-now>0:
 *             tripStartTime = s
 *             j=i                                         # j == row index pt             # <<<<<<<<<<<<<<
 *             k=3                                         # k == index pt for whether last point is ( startPt | endPt )
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":60
 *             tripStartTime = s
 *             j=i                                         # j == row index pt
 *             k=3                                         # k == index pt for whether last point is ( startPt | endPt )             # <<<<<<<<<<<<<<
 *         if e-now < tripStartTime-now and e-now>0:
 ...
 */
    ...
    /* "cython_exts/get_combo_start_info.pyx":61
 *             j=i                                         # j == row index pt
 *             k=3                                         # k == index pt for whether last point is ( startPt | endPt )
 *         if e-now < tripStartTime-now and e-now>0:             # <<<<<<<<<<<<<<
 *             tripStartTime = e
 *             j=i
 */
    __pyx_t_10 = (((__pyx_v_e - __pyx_v_now) < (__pyx_v_tripStartTime - __pyx_v_now)) != 0);
    if (__pyx_t_10) {
      __pyx_t_8 = (((__pyx_v_e - __pyx_v_now) > 0) != 0);
      __pyx_t_9 = __pyx_t_8;
    } else {
    ...
    if (__pyx_t_9) {
      ...
      /* "cython_exts/get_combo_start_info.pyx":62
 *             k=3                                         # k == index pt for whether last point is ( startPt | endPt )
 *         if e-now < tripStartTime-now and e-now>0:
 *             tripStartTime = e             # <<<<<<<<<<<<<<
 *             j=i
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":63
 *         if e-now < tripStartTime-now and e-now>0:
 *             tripStartTime = e
 *             j=i             # <<<<<<<<<<<<<<
 *             k=5
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":64
 *             tripStartTime = e
 *             j=i
 *             k=5             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":66
 *             k=5
 * 
 *     ai = returnVar[0]             # <<<<<<<<<<<<<<
 *     if n==0:
 ...
 */
  __pyx_t_3 = -1;
  __pyx_t_11.data = __pyx_v_returnVar.data;
  __pyx_t_11.memview = __pyx_v_returnVar.memview;
...
__pyx_t_11.shape[0] = __pyx_v_returnVar.shape[1];
__pyx_t_11.strides[0] = __pyx_v_returnVar.strides[1];
...
__PYX_XDEC_MEMVIEW(&__pyx_v_ai, 1);
  ...
  /* "cython_exts/get_combo_start_info.pyx":67
 * 
 *     ai = returnVar[0]
 *     if n==0:             # <<<<<<<<<<<<<<
 *         ai[0] = now
 ...
 */
  ...
  if (__pyx_t_9) {
    ...
    /* "cython_exts/get_combo_start_info.pyx":68
 *     ai = returnVar[0]
 *     if n==0:
 *         ai[0] = now             # <<<<<<<<<<<<<<
 *         ai[1] = new[2]      # tripPtA = start_node
 ...
 */
    __pyx_t_12 = 0;
    *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_12)) )) = __pyx_v_now;

    /* "cython_exts/get_combo_start_info.pyx":69
 *     if n==0:
 *         ai[0] = now
 *         ai[1] = new[2]      # tripPtA = start_node             # <<<<<<<<<<<<<<
 *         ai[5] = -1          # this signals an error
 ...
 */
    __pyx_t_13 = 2;
    __pyx_t_14 = 1;
    *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_14)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_new.data) + __pyx_t_13)) )));

    /* "cython_exts/get_combo_start_info.pyx":70
 *         ai[0] = now
 *         ai[1] = new[2]      # tripPtA = start_node
 *         ai[5] = -1          # this signals an error             # <<<<<<<<<<<<<<
 *         return returnVar
 ...
 */
    __pyx_t_15 = 5;
    *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_15)) )) = -1;

    /* "cython_exts/get_combo_start_info.pyx":71
 *         ai[1] = new[2]      # tripPtA = start_node
 *         ai[5] = -1          # this signals an error
 *         return returnVar             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "cython_exts/get_combo_start_info.pyx":73
 *         return returnVar
 *     else:
 *         aj      = o[j]             # <<<<<<<<<<<<<<
 *         ai[0]   = tripStartTime
 ...
 */
    __pyx_t_3 = -1;
    __pyx_t_16.data = __pyx_v_o.data;
    __pyx_t_16.memview = __pyx_v_o.memview;
...
__pyx_t_16.shape[0] = __pyx_v_o.shape[1];
__pyx_t_16.strides[0] = __pyx_v_o.strides[1];
    __pyx_t_16.suboffsets[0] = -1;

__pyx_v_aj = __pyx_t_16;
    __pyx_t_16.memview = NULL;
    __pyx_t_16.data = NULL;

    /* "cython_exts/get_combo_start_info.pyx":74
 *     else:
 *         aj      = o[j]
 *         ai[0]   = tripStartTime             # <<<<<<<<<<<<<<
 *         s       = aj[k]
 ...
 */
    __pyx_t_17 = 0;
    *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_17)) )) = __pyx_v_tripStartTime;

    /* "cython_exts/get_combo_start_info.pyx":75
 *         aj      = o[j]
 *         ai[0]   = tripStartTime
 *         s       = aj[k]             # <<<<<<<<<<<<<<
 *         ai[1]   = s                 # tripPtA = (start_A | end_A)
 ...
 */
    __pyx_t_3 = __pyx_v_k;
    __pyx_v_s = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_aj.data) + __pyx_t_3)) )));

    /* "cython_exts/get_combo_start_info.pyx":76
 *         ai[0]   = tripStartTime
 *         s       = aj[k]
 *         ai[1]   = s                 # tripPtA = (start_A | end_A)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_18 = 1;
    *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_18)) )) = __pyx_v_s;
  }

  /* "cython_exts/get_combo_start_info.pyx":78
 *         ai[1]   = s                 # tripPtA = (start_A | end_A)
 * 
 *     n = 0             # <<<<<<<<<<<<<<
 *     j = 0
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":79
 * 
 *     n = 0
 *     j = 0             # <<<<<<<<<<<<<<
 *     k = 0
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":80
 *     n = 0
 *     j = 0
 *     k = 0             # <<<<<<<<<<<<<<
 *     for i in range(r):
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":81
 *     j = 0
 *     k = 0
 *     for i in range(r):             # <<<<<<<<<<<<<<
 *         ai = o[i]
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_2; __pyx_t_5+=1) {
    ...
    /* "cython_exts/get_combo_start_info.pyx":82
 *     k = 0
 *     for i in range(r):
 *         ai = o[i]             # <<<<<<<<<<<<<<
 *         s  = ai[2]
 ...
 */
    __pyx_t_20 = -1;
    __pyx_t_19.data = __pyx_v_o.data;
    __pyx_t_19.memview = __pyx_v_o.memview;
...
__pyx_t_19.shape[0] = __pyx_v_o.shape[1];
__pyx_t_19.strides[0] = __pyx_v_o.strides[1];
...
__PYX_XDEC_MEMVIEW(&__pyx_v_ai, 1);
    ...
    /* "cython_exts/get_combo_start_info.pyx":83
 *     for i in range(r):
 *         ai = o[i]
 *         s  = ai[2]             # <<<<<<<<<<<<<<
 *         e  = ai[4]
 ...
 */
    __pyx_t_21 = 2;
    __pyx_v_s = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_21)) )));

    /* "cython_exts/get_combo_start_info.pyx":84
 *         ai = o[i]
 *         s  = ai[2]
 *         e  = ai[4]             # <<<<<<<<<<<<<<
 *         g  = 1
 ...
 */
    __pyx_t_22 = 4;
    __pyx_v_e = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_22)) )));

    /* "cython_exts/get_combo_start_info.pyx":85
 *         s  = ai[2]
 *         e  = ai[4]
 *         g  = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cython_exts/get_combo_start_info.pyx":90
 *         #     p1 = ai[5]
 *         #     p2 = ai[5]
 ...
 *             p2 = ai[5]
 */
    __pyx_t_9 = ((__pyx_v_now < __pyx_v_s) != 0);
    if (__pyx_t_9) {
      __pyx_t_10 = ((__pyx_v_now < __pyx_v_e) != 0);
    ...
    if (__pyx_t_8) {
      ...
      /* "cython_exts/get_combo_start_info.pyx":91
 *         #     p2 = ai[5]
 *         if (now < s and now < e):      # IF not start yet, use start point as start location
 *             p1 = ai[3]             # <<<<<<<<<<<<<<
 *             p2 = ai[5]
 ...
 */
      __pyx_t_23 = 3;
      __pyx_v_p1 = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_23)) )));

      /* "cython_exts/get_combo_start_info.pyx":92
 *         if (now < s and now < e):      # IF not start yet, use start point as start location
 *             p1 = ai[3]
 *             p2 = ai[5]             # <<<<<<<<<<<<<<
 *         elif (s <= now and now < e):   # ELIF, (already started | starting) & (ending now | ending later),
 ...
 */
      __pyx_t_24 = 5;
      __pyx_v_p2 = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_24)) )));
      goto __pyx_L11;
    }

    /* "cython_exts/get_combo_start_info.pyx":93
 *             p1 = ai[3]
 *             p2 = ai[5]
 *         elif (s <= now and now < e):   # ELIF, (already started | starting) & (ending now | ending later),             # <<<<<<<<<<<<<<
 *             p1 = ai[5]
 *             p2 = ai[5]
 */
    __pyx_t_8 = ((__pyx_v_s <= __pyx_v_now) != 0);
    if (__pyx_t_8) {
      __pyx_t_9 = ((__pyx_v_now < __pyx_v_e) != 0);
      __pyx_t_10 = __pyx_t_9;
    } else {
      __pyx_t_10 = __pyx_t_8;
    }
    if (__pyx_t_10) {
      ...
      /* "cython_exts/get_combo_start_info.pyx":94
 *             p2 = ai[5]
 *         elif (s <= now and now < e):   # ELIF, (already started | starting) & (ending now | ending later),
 *             p1 = ai[5]             # <<<<<<<<<<<<<<
 *             p2 = ai[5]
 ...
 */
      __pyx_t_25 = 5;
      __pyx_v_p1 = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_25)) )));

      /* "cython_exts/get_combo_start_info.pyx":95
 *         elif (s <= now and now < e):   # ELIF, (already started | starting) & (ending now | ending later),
 *             p1 = ai[5]
 *             p2 = ai[5]             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_t_26 = 5;
      __pyx_v_p2 = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_26)) )));
      goto __pyx_L11;
    }
    /*else*/ {

      /* "cython_exts/get_combo_start_info.pyx":97
 *             p2 = ai[5]
 *         else:
 *             g = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cython_exts/get_combo_start_info.pyx":99
 *             g = 0
 * 
 *         if g == 1:             # <<<<<<<<<<<<<<
 *             aj = returnVar[j]
 ...
 */
    ...
    if (__pyx_t_10) {
      ...
      /* "cython_exts/get_combo_start_info.pyx":100
 * 
 *         if g == 1:
 *             aj = returnVar[j]             # <<<<<<<<<<<<<<
 *             aj[4] = ai[0]       # deliveryID
 ...
 */
      __pyx_t_20 = -1;
      __pyx_t_27.data = __pyx_v_returnVar.data;
      __pyx_t_27.memview = __pyx_v_returnVar.memview;
...
__pyx_t_27.shape[0] = __pyx_v_returnVar.shape[1];
__pyx_t_27.strides[0] = __pyx_v_returnVar.strides[1];
    __pyx_t_27.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_aj, 1);
      __pyx_v_aj = __pyx_t_27;
      __pyx_t_27.memview = NULL;
      __pyx_t_27.data = NULL;

      /* "cython_exts/get_combo_start_info.pyx":101
 *         if g == 1:
 *             aj = returnVar[j]
 *             aj[4] = ai[0]       # deliveryID             # <<<<<<<<<<<<<<
 *             aj[5] = ai[1]       # orderTime
 ...
 */
      __pyx_t_28 = 0;
      __pyx_t_29 = 4;
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_aj.data) + __pyx_t_29)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_28)) )));

      /* "cython_exts/get_combo_start_info.pyx":102
 *             aj = returnVar[j]
 *             aj[4] = ai[0]       # deliveryID
 *             aj[5] = ai[1]       # orderTime             # <<<<<<<<<<<<<<
 *             j += 1
 ...
 */
      __pyx_t_30 = 1;
      __pyx_t_31 = 5;
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_aj.data) + __pyx_t_31)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ai.data) + __pyx_t_30)) )));

      /* "cython_exts/get_combo_start_info.pyx":103
 *             aj[4] = ai[0]       # deliveryID
 *             aj[5] = ai[1]       # orderTime
 *             j += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":105
 *             j += 1
 * 
 *             ak = returnVar[k]             # <<<<<<<<<<<<<<
 *             k += 1
 ...
 */
      __pyx_t_20 = -1;
      __pyx_t_32.data = __pyx_v_returnVar.data;
      __pyx_t_32.memview = __pyx_v_returnVar.memview;
...
__pyx_t_32.shape[0] = __pyx_v_returnVar.shape[1];
__pyx_t_32.strides[0] = __pyx_v_returnVar.strides[1];
    __pyx_t_32.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_ak, 1);
      __pyx_v_ak = __pyx_t_32;
      __pyx_t_32.memview = NULL;
      __pyx_t_32.data = NULL;

      /* "cython_exts/get_combo_start_info.pyx":106
 * 
 *             ak = returnVar[k]
 *             k += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":108
 *             k += 1
 * 
 *             t = n+2             # <<<<<<<<<<<<<<
 *             ak[t] = p1
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":109
 * 
 *             t = n+2
 *             ak[t] = p1             # <<<<<<<<<<<<<<
 *             t += 1
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ak.data) + __pyx_t_20)) )) = __pyx_v_p1;

      /* "cython_exts/get_combo_start_info.pyx":110
 *             t = n+2
 *             ak[t] = p1
 *             t += 1             # <<<<<<<<<<<<<<
 *             ak[t] = p2
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":111
 *             ak[t] = p1
 *             t += 1
 *             ak[t] = p2             # <<<<<<<<<<<<<<
 *             if k == z:
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ak.data) + __pyx_t_33)) )) = __pyx_v_p2;

      /* "cython_exts/get_combo_start_info.pyx":112
 *             t += 1
 *             ak[t] = p2
 *             if k == z:             # <<<<<<<<<<<<<<
 *                 k = 0
 *                 n = 2
 */
      __pyx_t_10 = ((__pyx_v_k == __pyx_v_z) != 0);
      if (__pyx_t_10) {

        /* "cython_exts/get_combo_start_info.pyx":113
 *             ak[t] = p2
 *             if k == z:
 *                 k = 0             # <<<<<<<<<<<<<<
 *                 n = 2
 ...
 */
        ...
        /* "cython_exts/get_combo_start_info.pyx":114
 *             if k == z:
 *                 k = 0
 *                 n = 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":116
 *                 n = 2
 * 
 *             ak = returnVar[k]             # <<<<<<<<<<<<<<
 *             k += 1
 ...
 */
      __pyx_t_35 = -1;
      __pyx_t_34.data = __pyx_v_returnVar.data;
      __pyx_t_34.memview = __pyx_v_returnVar.memview;
...
__pyx_t_34.shape[0] = __pyx_v_returnVar.shape[1];
__pyx_t_34.strides[0] = __pyx_v_returnVar.strides[1];
    __pyx_t_34.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_ak, 1);
      __pyx_v_ak = __pyx_t_34;
      __pyx_t_34.memview = NULL;
      __pyx_t_34.data = NULL;

      /* "cython_exts/get_combo_start_info.pyx":117
 * 
 *             ak = returnVar[k]
 *             k += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":119
 *             k += 1
 * 
 *             t = n+2             # <<<<<<<<<<<<<<
 *             ak[t] = p1
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":120
 * 
 *             t = n+2
 *             ak[t] = p1             # <<<<<<<<<<<<<<
 *             t += 1
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ak.data) + __pyx_t_35)) )) = __pyx_v_p1;

      /* "cython_exts/get_combo_start_info.pyx":121
 *             t = n+2
 *             ak[t] = p1
 *             t += 1             # <<<<<<<<<<<<<<
 *             ak[t] = p2
 ...
 */
      ...
      /* "cython_exts/get_combo_start_info.pyx":122
 *             ak[t] = p1
 *             t += 1
 *             ak[t] = p2             # <<<<<<<<<<<<<<
 *             if k == z:
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ak.data) + __pyx_t_36)) )) = __pyx_v_p2;

      /* "cython_exts/get_combo_start_info.pyx":123
 *             t += 1
 *             ak[t] = p2
 *             if k == z:             # <<<<<<<<<<<<<<
 *                 k = 0
 ...
 */
      ...
      if (__pyx_t_10) {
        ...
        /* "cython_exts/get_combo_start_info.pyx":124
 *             ak[t] = p2
 *             if k == z:
 *                 k = 0             # <<<<<<<<<<<<<<
 *                 n = 2
 ...
 */
        ...
        /* "cython_exts/get_combo_start_info.pyx":125
 *             if k == z:
 *                 k = 0
 *                 n = 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_exts/get_combo_start_info.pyx":127
 *                 n = 2
 * 
 *     aj = returnVar[j]  # sets deliv_id and orderTime for last row             # <<<<<<<<<<<<<<
 *     aj[4] = new[0]
 ...
 */
  __pyx_t_5 = -1;
  __pyx_t_37.data = __pyx_v_returnVar.data;
  __pyx_t_37.memview = __pyx_v_returnVar.memview;
...
__pyx_t_37.shape[0] = __pyx_v_returnVar.shape[1];
__pyx_t_37.strides[0] = __pyx_v_returnVar.strides[1];
    __pyx_t_37.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_aj, 1);
  __pyx_v_aj = __pyx_t_37;
  __pyx_t_37.memview = NULL;
  __pyx_t_37.data = NULL;

  /* "cython_exts/get_combo_start_info.pyx":128
 * 
 *     aj = returnVar[j]  # sets deliv_id and orderTime for last row
 *     aj[4] = new[0]             # <<<<<<<<<<<<<<
 *     aj[5] = new[1]
 ...
 */
  __pyx_t_38 = 0;
  __pyx_t_39 = 4;
  *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_aj.data) + __pyx_t_39)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_new.data) + __pyx_t_38)) )));

  /* "cython_exts/get_combo_start_info.pyx":129
 *     aj = returnVar[j]  # sets deliv_id and orderTime for last row
 *     aj[4] = new[0]
 *     aj[5] = new[1]             # <<<<<<<<<<<<<<
 *     # k = z-2
 ...
 */
  __pyx_t_40 = 1;
  __pyx_t_41 = 5;
  *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_aj.data) + __pyx_t_41)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_new.data) + __pyx_t_40)) )));

  /* "cython_exts/get_combo_start_info.pyx":134
 *     # ak[3] = new[2]
 *     # k += 1
 *     k = z-1             # <<<<<<<<<<<<<<
 *     ak = returnVar[k]
 *     ak[2] = new[2]
 */
  __pyx_v_k = (__pyx_v_z - 1);

  /* "cython_exts/get_combo_start_info.pyx":135
 *     # k += 1
 *     k = z-1
 *     ak = returnVar[k]             # <<<<<<<<<<<<<<
 *     ak[2] = new[2]
 ...
 */
  __pyx_t_5 = -1;
  __pyx_t_42.data = __pyx_v_returnVar.data;
  __pyx_t_42.memview = __pyx_v_returnVar.memview;
...
__pyx_t_42.shape[0] = __pyx_v_returnVar.shape[1];
__pyx_t_42.strides[0] = __pyx_v_returnVar.strides[1];
    __pyx_t_42.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_ak, 1);
  __pyx_v_ak = __pyx_t_42;
  __pyx_t_42.memview = NULL;
  __pyx_t_42.data = NULL;

  /* "cython_exts/get_combo_start_info.pyx":136
 *     k = z-1
 *     ak = returnVar[k]
 *     ak[2] = new[2]             # <<<<<<<<<<<<<<
 *     ak[3] = new[3]
 ...
 */
  __pyx_t_43 = 2;
  __pyx_t_44 = 2;
  *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ak.data) + __pyx_t_44)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_new.data) + __pyx_t_43)) )));

  /* "cython_exts/get_combo_start_info.pyx":137
 *     ak = returnVar[k]
 *     ak[2] = new[2]
 *     ak[3] = new[3]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_45 = 3;
  __pyx_t_46 = 3;
  *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_ak.data) + __pyx_t_46)) )) = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_new.data) + __pyx_t_45)) )));

  /* "cython_exts/get_combo_start_info.pyx":139
 *     ak[3] = new[3]
 * 
 *     return returnVar             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("cython_exts.get_combo_start_info.c_get_combo_start_info", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static PyObject *__pyx_pw_11cython_exts_20get_combo_start_info_1c_get_combo_start_info(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("c_get_combo_start_info (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_new,&__pyx_n_s_o,&__pyx_n_s_returnVar,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_o)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("c_get_combo_start_info", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_returnVar)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("c_get_combo_start_info", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "c_get_combo_start_info") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_new = __Pyx_PyObject_to_MemoryviewSlice_dc_long(values[0]); if (unlikely(!__pyx_v_new.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_o = __Pyx_PyObject_to_MemoryviewSlice_d_dc_long(values[1]); if (unlikely(!__pyx_v_o.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_returnVar = __Pyx_PyObject_to_MemoryviewSlice_d_dc_long(values[2]); if (unlikely(!__pyx_v_returnVar.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("c_get_combo_start_info", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_exts.get_combo_start_info.c_get_combo_start_info", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11cython_exts_20get_combo_start_info_c_get_combo_start_info(__pyx_self, __pyx_v_new, __pyx_v_o, __pyx_v_returnVar);
...
static PyObject *__pyx_pf_11cython_exts_20get_combo_start_info_c_get_combo_start_info(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_new, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_returnVar) {
  ...
  if (unlikely(!__pyx_v_new.memview)) { __Pyx_RaiseUnboundLocalError("new"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_o.memview)) { __Pyx_RaiseUnboundLocalError("o"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_returnVar.memview)) { __Pyx_RaiseUnboundLocalError("returnVar"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_1 = __pyx_f_11cython_exts_20get_combo_start_info_c_get_combo_start_info(__pyx_v_new, __pyx_v_o, __pyx_v_returnVar, 0); if (unlikely(!__pyx_t_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  __Pyx_NAMESTR("cython_exts.get_combo_start_info.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("cython_exts.get_combo_start_info.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("cython_exts.get_combo_start_info.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("cython_exts.get_combo_start_info._memoryviewslice"), /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("c_get_combo_start_info"), (PyCFunction)__pyx_pw_11cython_exts_20get_combo_start_info_1c_get_combo_start_info, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_11cython_exts_20get_combo_start_info_c_get_combo_start_info)},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("get_combo_start_info"),
    0, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initget_combo_start_info(void); /*proto*/
PyMODINIT_FUNC initget_combo_start_info(void)
#else
PyMODINIT_FUNC PyInit_get_combo_start_info(void); /*proto*/
PyMODINIT_FUNC PyInit_get_combo_start_info(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_get_combo_start_info(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("get_combo_start_info"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_exts__get_combo_start_info) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cython_exts.get_combo_start_info")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_exts.get_combo_start_info", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cython_exts/get_combo_start_info.pyx":2
 * 
 * cimport cython             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cython_exts.get_combo_start_info", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_exts.get_combo_start_info");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
